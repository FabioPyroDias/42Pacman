...
PLAYER_UP_SPRITE_INDEX_Y = 0
PLAYER_LEFT_SPRITE_INDEX_Y = 1
PLAYER_RIGTH_SPRITE_INDEX_Y = 2
PLAYER_DOWN_SPRITE_INDEX_Y = 3
PALYER_DEATH_SPRITE_START_INDEX_Y = 4
PALYER_DEATH_SPRITE_LAST_INDEX_Y = 7

# GHOST SPRITES
GHOST_SPRITE_LAST_INDEX_X = 1
GHOST_DOWN_SPRITE__INDEX_Y = 0
GHOST_RIGHT_SPRITE__INDEX_Y = 1
GHOST_LEFT_SPRITE__INDEX_Y = 2
GHOST_UP_SPRITE__INDEX_Y = 3
